...
export const CurrencyManagement = () => {
  ...
  // const { apiData: leadsAmountData, loading: dataLoading } =
  //   useApi("admin/leads-amount");
  // const { apiData: leadsAmountMonthlyData, loading: leadLoading } = useApi(
  //   "admin/leads-amount-monthly"
  // );
  // const { apiData: leadsAmountReceivedData, loading: receivedLoading } = useApi(
  //   "admin/leads-amount-received"
  // );
  // const { apiData: leadsAmountReceivedMonthlyData, loading: AmountLoading } =
  ...
  // }, [
  //   leadsAmountData,
  //   leadsAmountMonthlyData,
  //   leadsAmountReceivedData,
  //   leadsAmountReceivedMonthlyData,
  // ]);
